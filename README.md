...
- Adds the following packages to the base image:
  ...
  - A selection of [udev rules and service units](https://github.com/iansantosdev/config)
  - [libratbag](https://github.com/libratbag/libratbag), to configure supported mice via [piper](https://github.com/libratbag/piper)
  - Various other tools: check out the [complete list of packages](https://github.com/iansantosdev/ublue-main/blob/main/packages.json)
...
iansantosdev/base-main is also very well suited for servers, and users are expected to make full use of `podman` to host containers running "typical" server software i.e. `nginx`, `caddy` and others.

## How to Install

1. [Download the image you want](https://github.com/iansantosdev/ublue-main/releases)
1. [Follow these instructions](https://ublue.it/installation)
1. [File an issue](https://github.com/iansantosdev/ublue-main/issues) if you find a problem
...
With that said, you can individually disable which automatic update timers [iansantosdev/config](https://github.com/iansantosdev/config) provides with the following commands:
